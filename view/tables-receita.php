<?php 
  ...
  $receitas = $financaDAO->getReceitaMes();
  $paginas = $financaDAO->getReceitaMes();
  ...
  $sql = "SELECT * FROM receita WHERE usuario_idusuario = $id ORDER BY id_receita DESC LIMIT ".$inicio. ", ". $limite;
  try{
    $pdo = Conexao::getInstance();
    $receitas = $pdo->prepare($sql);
    $receitas->execute();
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Histórico de receita</h1>
          <p class="mb-4">Aqui estão listados todas as receitas .</p>
            ...
            <div class="card-body">
              <div class="table-responsive pt-3">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php while($receita = $receitas->fetch(PDO::FETCH_ASSOC)):
                        $date = $receita['data_rec'];
                        $data =  date('d/m/Y', strtotime($date));
                    ?>
                    <tr>
                      <td><?php echo $receita['nome_rec']; ?></td>
                      <td><?php echo $receita['tipo_rec']; ?></td>
                      <td><?php echo number_format($receita['valor_rec'], 2, ',', '.'); ?></td>
                      <td><?php echo $receita['status_rec']; ?></td>
                      <td><?php echo $data; ?></td>
                      <td><?php echo $receita['doc_rec']; ?></td>
                    </tr>
                    <?php endwhile; ?>
                  </tbody>
                </table>
